...
class DeepableTreeModelDelegate(QAbstractItemModelDelegate[DeepableQModelIndex]):
	...
	def data(self, index: DeepableQModelIndex, role: int = Qt.DisplayRole) -> typing.Any:
	...
	def setData(self, index: DeepableQModelIndex, value: typing.Any, role: int = Qt.DisplayRole) -> bool:
		model = index.model()
		if index.column() == 1:
