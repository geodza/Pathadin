...
class SimpleActions:
	...
	active_annotation_service_provider: InitVar[ActiveAnnotationServiceProvider]
	...
	def __post_init__(self, parent_: QObject, active_view_provider: ActiveViewProvider,
					  ...
					  active_annotation_service_provider: ActiveAnnotationServiceProvider,
		...
		def annotation_service_closure(func):
			def f(checked: bool):
				# annotations_tree_view = active_annotation_tree_view_provider.active_annotation_tree_view
				view = active_view_provider.active_view
				annotation_service = active_annotation_service_provider.active_annotation_service
